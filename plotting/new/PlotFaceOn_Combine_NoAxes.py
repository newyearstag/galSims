...
ax1.scatter(xdataS,ydataS,s=sizedataS,facecolors='none', edgecolors='lightgrey')
ax1.set_ylim([-20,20])
ax1.set_xlim([-20,20])
ax1.axis('off')
...
ax2.scatter(xdataW,ydataW,s=sizedataW,facecolors='none', edgecolors='lightgrey')
ax2.set_ylim([-20,20])
ax2.set_xlim([-20,20])
ax2.axis('off')
...
#fig.savefig('FaceOnPlot_Combine_NoAxes.eps', format='eps', dpi=1000)
#fig.savefig('FaceOnPlot_Combine_NoAxes.pdf', format='pdf', dpi=1000)
fig.savefig('FaceOnPlot_Combine_NoAxes.png', format='png', dpi=1000, transparency=0)
fig.show()

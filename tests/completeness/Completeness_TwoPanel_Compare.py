...
ax1.hist(lumKnownNorth, bins=np.logspace(-4, 2, 59), histtype='step',color='black',linewidth=LnWidth+1.5)
ax1.hist(lumN, bins=np.logspace(-4, 2, 59), histtype='step',color='blue',linewidth=LnWidth)
ax1.hist(lumNB2, bins=np.logspace(-4, 2, 59), histtype='step',color='red',linewidth=LnWidth)
...
ax1.set_ylim([pow(10,0),pow(10,2.5)])
ax1.set_xscale('log')
ax1.set_yscale('log')
...
ax2.hist(lumKnownSouth, bins=np.logspace(-4, 2, 59), histtype='step',color='black',linewidth=LnWidth+1.5)
ax2.hist(lumS, bins=np.logspace(-4, 2, 59), histtype='step',color='blue',linewidth=LnWidth)
ax2.hist(lumSB2, bins=np.logspace(-4, 2, 59), histtype='step',color='red',linewidth=LnWidth)
...
ax2.set_xscale('log')
ax2.set_yscale('log')
ax2.set_ylim([pow(10,0),pow(10,2.5)])
ax2.set_xlim([pow(10,-4),pow(10,2)])
...
ax2.plot([pow(10,-4), pow(10,-4)], [pow(10,3), pow(10,0)], 'k-', lw=3)
...
plt.setp((ax1,ax2), xticks=[pow(10,-3), pow(10,-2), pow(10,-1),pow(10,0),pow(10,1)])
...
# Curve labels
ax1.text(pow(10,-.5),pow(10,2.3),'B2 & Earlier',ha='left', color='red',fontsize=TxtSize-5)
ax1.text(pow(10,-.5),pow(10,2.1),'O9.5 & Earlier',ha='left', color='blue',fontsize=TxtSize-5)
ax1.text(pow(10,-.5),pow(10,1.9),'Observed',ha='left', color='black',fontsize=TxtSize-5)

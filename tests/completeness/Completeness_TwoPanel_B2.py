...
ax1.set_xscale('log')
ax1.set_yscale('log')
ax1.set_title("Quadrant I (B2)",fontsize=TxtSize)
...
ax2.set_title("Quadrant IV (B2)",fontsize=TxtSize)
...
fig.savefig('FluxBinned_FirstFourthQuads_B2.eps', format='eps', dpi=1000)
fig.show()

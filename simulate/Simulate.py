...
numSpirals = 2 # Determines Number of Spiral arms
pitchAngle =  7.3*math.pi/180 # Determines curvature of arms
...
sigma = 0.2 # Sets FWHM of spiral arms to (x) kpc
...
while region <= numRegions :
    ...
    and (spiral == True):
        while i != 0 : # This loop forces an Hii region to be populated in arms
            ...
            r = extentOfBar*math.exp(pitchAngle*(1 - .2*math.floor(whichArm/2))*theta) # (.2 ARBITRARY)
